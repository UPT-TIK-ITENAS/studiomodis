...
class AlatController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.peminjaman.alat.create', compact('peminjaman_ruangan', 'alat', 'cart'));
    }
    ...
    public function confirm()
    {
        ...
        session()->put('peminjaman_alat_admin_only', $peminjaman_alat);
        // dd($peminjaman_ruangan);
        return view('admin.peminjaman.alat.confirm', compact('peminjaman_alat_admin_only'));
    }

    public function confirmStore(Request $request)
    {
        if (session()->get('peminjaman_alat_admin_only')) {
            $peminjaman = session()->get('peminjaman');
            $peminjaman_alat = session()->get('peminjaman_alat_admin_only');
            ...
            session()->forget(['peminjaman_alat_admin_only']);
