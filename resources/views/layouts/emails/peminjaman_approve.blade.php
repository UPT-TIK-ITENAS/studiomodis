            ...
            ">
                  ...
                  ">
                    ...
                    ">
                      ...
                      ">
                        ...
                        ">
                                            <!--<![endif]-->
                                            <table id="u_content_image_4" style="font-family: 'Montserrat', sans-serif"
                                ...
                                " align="left">
                                      ...
                                      " align="center">
                                                                        <img align="center" border="0"
                                                                            src="{{ asset('assets/images/email/image-5.png') }}"
                                          ...
                                          width: 44%;
                                          max-width: 255.2px;
                                        " width="255.2" class="v-src-width v-src-max-width" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                      ...
                      ">
                        ...
                        ">
                                ...
                                " align="left">
                                      ...
                                      " align="center">
                                                                        <img align="center" border="0"
                                                                            src="{{ asset('assets/images/email/checked.png') }}"
                                                                            alt="Tick Icon" title="Tick Icon" style="
                                          outline: none;
                                          text-decoration: none;
                                          -ms-interpolation-mode: bicubic;
                                          clear: both;
                                ...
                                " align="left">
                                  ...
                                  ">
                                        ...
                                        font-size: 16px;
                                        line-height: 27.2px;
                                      ">Silakan login untuk mendapatkan informasi
                                                                        lebih lanjut</span>
                                                                </p>
                                                            </div>
                                                        </td>
                ...
                ">
                  ...
                  ">
                                ...
                                <div class="u-col u-col-18" style="
                      max-width: 320px;
                      min-width: 108px;
                      display: table-cell;
                      vertical-align: top;
                        ...
                        ">
                                ...
                                " align="left">
                                                            <table height="0px" align="center" border="0"
                                                                cellpadding="0" cellspacing="0" width="100%" style="
                                    border-collapse: collapse;
                                    table-layout: fixed;
                                    border-spacing: 0;
                                    mso-table-lspace: 0pt;
                                ...
                                <!--[if (mso)|(IE)]></td><![endif]-->
                                <!--[if (mso)|(IE)]><td align="center" width="380" style="background-color: #624bff;width: 380px;padding: 20px;border-top: 1px solid #CCC;border-left: 1px solid #CCC;border-right: 1px solid #CCC;border-bottom: 1px solid #CCC;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
                                <div class="u-col u-col-63p66" style="
                      max-width: 320px;
                      min-width: 382px;
                      display: table-cell;
                      vertical-align: top;
                      ...
                      ">
                        ...
                        ">
                                ...
                                " align="left">
                                  ...
                                  ">
                                                                @php
                                                                    if ($borrows->ruangan->count() != 0) {
                                                                        $status = 'Ruangan : ' . $borrows->ruangan[0]->no_ruangan . ' ' . $borrows->ruangan[0]->nama;
                                                                        $url = route('user.peminjaman.ruangan.show', $borrows->id);
                                                                    } else {
                                                                        $status = 'Alat yang dipinjam : ' . $borrows->alat->count();
                                                                        $url = route('user.peminjaman.alat.show', $borrows->id);
                                                                    }
                                                                @endphp
                                ...
                                " align="left">
                                  ...
                                  ">
                                        ...
                                        line-height: 28px;
                                      "><strong>✓</strong></span>
                                                                    &nbsp;Nomor Surat : {{ $borrows->nomor_surat }}
                                                                </p>
                                                                <p style="font-size: 15px; line-height: 200%">
                                                                    <span style="
                                        color: #f7e1b5;
                                      ...
                                      ">✓</span>
                                                                    &nbsp;Waktu :
                                                                    {{ $borrows->begin_date . ' - ' . $borrows->end_date }}
                                                                </p>
                                                                <p style="font-size: 15px; line-height: 200%">
                                                                    <span style="
                                        color: #f7e1b5;
                                ...
                                <div class="u-col u-col-18p34" style="
                      max-width: 320px;
                      min-width: 110px;
                      display: table-cell;
                      vertical-align: top;
                      ...
                      ">
                        ...
                        ">
                                ...
                                " align="left">
                                    ...
                                    font-size: 26px;
                                  ">
                                                                <strong>Ingin mengetahui lebih lanjut?</strong>
                                                            </h1>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                ...
                                " align="left">
                                    ...
                                    ">
                                      ...
                                      "><strong><span style="
                                            font-size: 16px;
                                            line-height: 19.2px;
                                          ">Click Here &rarr;</span></strong></span>
                                                                </a>
                    ...
                    ">
                      ...
                      ">
                        ...
                        ">
                                ...
                                " align="left">
                                  ...
                                  ">
                                                                <p style="font-size: 14px; line-height: 180%">
                                                                    Jl. PH.H. Mustofa No.23, Neglasari, Kec.
                                                                    Cibeunying Kaler,
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 180%">
                                ...
                                " align="left">
                                                            <table height="0px" align="center" border="0"
                                                                cellpadding="0" cellspacing="0" width="82%" style="
                                    border-collapse: collapse;
                                    table-layout: fixed;
                                    border-spacing: 0;
                                    mso-table-lspace: 0pt;
