                ...
                <div class="card-body">
                    <div class=" mb-6">
                        <div class="d-flex align-items-center">
                            <div class="">
                                <a href="{{ route('user.peminjaman.ruangan.alat') }}" class="btn btn-sm btn-primary"><i
                    ...
                    <div>
                        ...
                        <div class="mb-3 row align-items-center">
                            ...
                            <div class="col-md-9 col-12 col-form-label form-label">
                                <p class="mb-0">
                                    {{ $peminjaman_ruangan['begin_date'] . ' ' . $peminjaman_ruangan['jam_awal'] }}</p>
                            </div>
                        </div>
                        <div class="mb-3 row align-items-center">
                            ...
                            <div class="col-md-9 col-12 col-form-label form-label">
                                <p class="mb-0">
                                    {{ $peminjaman_ruangan['end_date'] . ' ' . $peminjaman_ruangan['jam_akhir'] }}</p>
                            </div>
                        </div>
                    </div>
