        ...
        <div class="col-xl-12 mt-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div>
                        <form action="{{ route('admin.user.update', $user->idpegawai) }}" method="post">
                            @csrf
                            @method('PUT')
                            <!-- row -->
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-9 col-12 mb-2 mb-lg-0">
                                    ...
                                    @enderror">
                                        <option value=""></option>
                                        @foreach ($unit as $u)
                                            <option value="{{ $u->idunit }}" @if ($user->idunit == $u->idunit) selected @endif>
                                                {{ $u->namaunit }}</option>
                                        @endforeach
                                    </select>
                                    @error('unit')
                                ...
                                <div class="col-md-9 col-12 mb-2 mb-lg-0">
                                    ...
                                    @enderror">
                                        ...
                                        @foreach ($jabatan as $j)
                                            <option value="{{ $j->idjabatan }}" @if ($user->idjabatan == $j->idjabatan) selected @endif>
                                                {{ $j->namajabatan }}</option>
                                        @endforeach
                                    </select>
                                    @error('jabatan')
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-9 col-12 mb-2 mb-lg-0">
                                    ...
                                    @enderror">
                                        <option value="{{ $user->nikatasan }}" selected>{{ $atasan1->namapegawai }}
                                        </option>
                                    </select>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-9 col-12 mb-2 mb-lg-0">
                                    ...
                                    @enderror">
                                        @if ($atasan2 != null)
                                            <option value="{{ $user->nikatasan2 }}" selected>
                                                {{ $atasan2->namapegawai }}
                                            </option>
                                        @endif
                                    </select>
