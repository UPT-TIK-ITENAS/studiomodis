    ...
    <div class="row">
        ...
        <div class="col-xl-12 mt-6">
            <div class="card">
                <div class="card-body">
                    <div class=" mb-6">
                        <h4 class="mb-1">Edit Sumber Daya</h4>
                    </div>
                    <div>
                        <form action="{{ route('admin.sumber-daya.update', $sumberDaya->id) }}" method="post"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-9 col-12 mb-2 mb-lg-0">
                                    <input type="text" class="form-control @error('nama_dokumen') is-invalid @enderror"
                                        placeholder="Nama dokumen" name="nama_dokumen" id="nama_dokumen"
                                        value="{{ old('nama_dokumen') ?? $sumberDaya->nama_dokumen }}" required>
                                    @error('nama_dokumen')
                                ...
                                <div class="col-md-9 col-12 mb-2 mb-lg-0">
                                    <div class="custom-file">
                                        <input type="file" class="dropify form-control" name="file_dokumen"
                                            ...
                                            data-default-file="{{ asset('dokumen/' . $sumberDaya->file_dokumen) }}">
                                    </div>
                                    @error('file_dokumen')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-9 col-12 mb-2 mb-lg-0">
                                    <select class="form-select @error('status') is-invalid @enderror" name="status"
                                        id="status">
                                        <option></option>
                                        <option value="0" @if ($sumberDaya->status == 0) selected @endif>Tidak Aktif
                                        </option>
                                        <option value="1" @if ($sumberDaya->status == 1) selected @endif>Aktif</option>
                                    </select>
                                    @error('status')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
