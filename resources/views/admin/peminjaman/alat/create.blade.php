            ...
            <div>
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        @if ($cart->count() > 0)
                            <a href="{{ route('admin.peminjaman.alat.confirm') }}" class="btn btn-info text-white">
                                Konfirmasi
                            </a>
                        @endif
                    </div>
...
@push('scripts')
    ...
    <script>
        ...
        let table = $('#alat-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.peminjaman.alat.list', 'alat') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
                    orderable: false
        ...
        let cartTable = $('#cart-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.peminjaman.alat.list', 'cart') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
                    orderable: false
