        ...
        <div class="col-lg-12 col-md-12 col-12">
            ...
            <div class="card mb-3">
                <div class="card-title py-3">
                    {{ Breadcrumbs::render('admin.ruangan.edit', $ruangan) }}
                </div>
            </div>
            <div>
                        ...
                        <form action="{{ route('admin.ruangan.update', $ruangan->id) }}" method="post">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-9 col-12">
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                        placeholder="Nama ruangan" name="nama" id="nama"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-9 col-12">
                                    <input type="text" class="form-control @error('no_ruangan') is-invalid @enderror"
                                        placeholder="Nomor Ruangan" id="no_ruangan" name="no_ruangan"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-9 col-12">
                                    <input type="text" class="form-control @error('deskripsi') is-invalid @enderror"
                                        ...
                                        value="{{ old('deskripsi') ?? $ruangan->deskripsi }}" required>
                                    @error('deskripsi')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-9 col-12 mb-2 mb-lg-0">
                                    ...
                                    @enderror">
                                        <option></option>
                                        <option value="1" @if ($ruangan->status == 1) selected @endif>Aktif</option>
                                        <option value="0" @if ($ruangan->status == 0) selected @endif>Tidak Aktif</option>
                                    </select>
                                    @error('status')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
